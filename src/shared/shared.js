...
export const productsBanner = [
  {
    title: "CAPITAL GREEN",
    text:
      "Vaš partner na putu ka modernoj poljoprivrednoj proizvodnji! Ovde možete pronaći sve stručne informacije o profesionalnoj proizvodnji i zaštiti bilja, a koje mogu biti korisne za Vas i Vaše poslovanje.",
  },
  {
...
export const details2 = [
  {
    title: "DOBRODOŠLI NA NAŠ SAJT!",
    paragraph:
      "Na našem sajtu možete se upoznati sa prodajnim asortimanom, novim tehnologijama u poljoprivredi, kao i inovativnim načinom uzgoja biljaka. Pogledajte našu ponudu i izaberite samo najbolje.",
    button_title: "O nama",
  },
  {
    phone: "+ 381 64 5 222 333",
    paragraph: "Uvek smo spremni da poboljšamo i unapredimo Vašu proizvodnju.",
